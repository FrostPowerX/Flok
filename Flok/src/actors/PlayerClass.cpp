...
void PlayerClass::Init() {
  ...
  Player.f_Sprite = LoadTexture(
      "res/ToxicFrog/BlueBlue/ToxicFrogBlueBlue_Hop.png");
...
void PlayerClass::Draw() {
  ...
  DrawTexturePro(Player.f_Sprite,
                 ...
                 {.x = (Player.f_BoundingBox.width * k_Scale) / 2.0F,
                  .y = (Player.f_BoundingBox.height * k_Scale) / 2.0F},
